...
**Database:** PostgreSQL · Prisma ORM · SQLite

**Cloud & DevOps:** AWS (Lambda · EC2 · S3 · DynamoDB · ECS · VPC) · Docker · GitHub Actions
...
*Open to full-time opportunities in software development, cloud, IT support, data, or health informatics.*
